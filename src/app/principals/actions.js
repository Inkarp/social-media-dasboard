 ...
 * — see src/lib/action-result.js. `npm run verify:actions` enforces it.
 *
 ...
 */
export async function saveTargetAction(formData) {
 ...
 * @returns {Promise<ActionResult>}
 */
export async function createPrincipalAction(formData) {
 ...
 * @returns {Promise<ActionResult>}
 */
export async function updatePrincipalAction(formData) {
 ...
 * @returns {Promise<ActionResult>}
 */
export async function retirePrincipalAction(formData) {
 ...
 * @returns {Promise<ActionResult>}
 */
export async function restorePrincipalAction(formData) {
  const parsed = z.object({ id: uuid }).safeParse({ id: formData.get('id') })
  if (!parsed.success) return { ok: false, error: 'That brand could not be identified.' }
 ...
 * @returns {string}
 */
function describe(message, subject) {
