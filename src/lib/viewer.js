 ...
 *
 * Kept separate from src/lib/auth.js deliberately. That module reads cookies via
 ...
 * @property {boolean} isEditor True when the session belongs to a user listed in `admin_users` — see
 ...
 * @property {boolean} hasSession True whenever there is a valid Supabase session, admin or not. Now that
 ...
 * @property {boolean} canSignIn False when no Supabase project is attached — signing in is impossible.
 */
