 ...
 * }} props
 */
export function CalibratedBar({ implemented, planned, showPercentage = true, label, className }) {
  ...
  const description = label ?? `${done} of ${target} published — ${percentage} per cent of target`
